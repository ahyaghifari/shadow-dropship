...
function orderDetailComp($order_detail){?>
   <div id="order-detail" class="mx-auto sm:w-11/12">
    <button  onClick="javascript:history.back();" class="float-right"><span class="material-symbols-rounded text-xl text-neutral-400 md:text-2xl md:text-neutral-200">
        arrow_back_ios</span></button>
        <div id="order-detail-header" class="clear-both border-b border-neutral-500 border-dashed pb-2">
            <h1 class="text-md:text-2xl">Detail Pesanan : <span class="font-semibold"><?= $_GET['order-detail'] ?></span> </h1>
        </div>
